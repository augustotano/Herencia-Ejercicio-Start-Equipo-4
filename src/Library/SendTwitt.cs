...
namespace Library
{
    ...
    {
        //la idea es que la clase de la api de la cara use este metodo para publicar, creo que queda mas limpio que repetir 
        //este codigo en los dos metodos de la clase correctface ---vale
